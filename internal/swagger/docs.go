...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Spectre Proxy",
            "url": "https://spectre.sh"
        },
        "license": {
            "name": "MIT",
            "url": "https://github.com/ChxisB/spectre-proxy/blob/main/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_spectre-proxy_spectre-proxy_internal_proto.Message"
                            }
                        }
                    },
                    "404": {
    ...
    "definitions": {
        ...
        "github_com_spectre-proxy_spectre-proxy_internal_config.Config": {
            "type": "object",
            "properties": {
                "$schema": {
                    "type": "string"
                ...
                "options": {
                    "$ref": "#/definitions/github_com_spectre-proxy_spectre-proxy_internal_config.Options"
                },
                "permissions": {
        ...
        "github_com_spectre-proxy_spectre-proxy_internal_config.Options": {
            "type": "object",
            "properties": {
                "attribution": {
        ...
        "github_com_spectre-proxy_spectre-proxy_internal_proto.Message": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "integer"
        ...
        "proto.Workspace": {
            ...
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_spectre-proxy_spectre-proxy_internal_config.Config"
                },
                "data_dir": {
                    "type": "string"
                },
...
var SwaggerInfo = &swag.Spec{
	...
	Schemes:          []string{},
	Title:            "Spectre API",
	Description:      "Spectre is a terminal-based AI coding assistant. This API is served over a Unix socket (or Windows named pipe) and provides programmatic access to workspaces, sessions, agents, LSP, MCP, and more.",
