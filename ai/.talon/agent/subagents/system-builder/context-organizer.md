...
# .talon/config/agent-metadata.json
  ...
  <operation name="error">
    Load: .talon/context/core/context-system/operations/error.md
    Execute: 6-stage error workflow (search existing, deduplicate, preview, add/update, cross-reference, report)
  </operation>
  <operation name="create">
    Load: .talon/context/core/context-system/guides/creation.md
