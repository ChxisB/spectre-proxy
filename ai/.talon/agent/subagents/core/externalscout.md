...
<critical_rules priority="absolute" enforcement="strict">
  <rule id="tool_usage">
    ALLOWED: 
    - read: ONLY .talon/skills/context7/** and .tmp/external-context/**
    ...
    - glob: ONLY .talon/skills/context7/** and .tmp/external-context/**
...
<workflow_execution>
  ...
  <stage id="1" name="DetectLibrary">
    ...
    <process>
      1. Read `.talon/skills/context7/library-registry.md`
...
**Library Registry**: `.talon/skills/context7/library-registry.md` — Supported libraries, IDs, and official docs links
...
3. Suggest checking `.talon/context/` for cached docs
