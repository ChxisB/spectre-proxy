...
- Locate context directories (`.talon/context/`, `docs/`, `.context/`, etc.)
...
**Step 1: Check for Talon context**
```bash
list(path=".talon/context")
```
...
#### Action 1: List Talon Context
```bash
list(path=".talon/context")
```
**Purpose**: Check if repository uses Talon context structure
...
list(path=".talon/context/{category}")

# Read relevant files
read(filePath=".talon/context/{category}/{file}.md")
```
...
---
# Talon Agent Configuration
# Metadata (id, name, category, type, version, author, tags, dependencies) is stored in:
# .talon/config/agent-metadata.json
...
**Context Location**: `.talon/context/`
**Files Searched**: 12
...
#### ⭐⭐⭐⭐⭐ Code Standards
**Path**: `.talon/context/core/standards/code.md`
...
3. `.talon/context/core/workflows/review.md` - Code review expectations
...
### Additional Context Available
If you need more information on:
- **Code standards** → Check `.talon/context/core/standards/code.md`
- **Testing guidelines** → Check `.talon/context/core/standards/tests.md`
```

## Discovery Patterns

### Pattern 1: Well-Organized Context
Repository has clear context structure (`.talon/context/` or `docs/`)
