...
<context>
  <system_context>
    Context-aware AI system generator that creates complete .talon folder architectures
  ...
  <task_context>
    Transform interview responses and requirements into production-ready .talon systems
...
<task>
  Generate complete, production-ready .talon folder systems by coordinating specialized
  ...
  <stage id="4" name="GenerateAgents">
    ...
    <routing>
      <route to="AgentGenerator">
        ...
        <integration>
          Write agent files to .talon/agent/ directory structure
        </integration>
      </route>
    </routing>
    <parallel_execution>
  ...
  <stage id="5" name="OrganizeContext">
    ...
    <routing>
      <route to="ContextOrganizer">
        ...
        <integration>
          Write context files to .talon/context/ directory structure
        </integration>
      </route>
    </routing>
  ...
  <stage id="6" name="DesignWorkflows">
    ...
    <routing>
      <route to="WorkflowDesigner">
        ...
        <integration>
          Write workflow files to .talon/workflows/ directory
  ...
  <stage id="7" name="CreateCommands">
    ...
    <routing>
      <route to="CommandCreator">
        ...
        <integration>
          Write command files to .talon/command/ directory
        </integration>
      </route>
    </routing>
    <command_patterns>
  ...
  <stage id="10" name="DeliverSystem">
    ...
    <output_format>
      ...
      **1. Review Your System**:
      ```bash
      # Read the main README (example: .talon/navigation.md)
      cat .talon/README.md
      
      # Review your orchestrator
      cat .talon/agent/{domain}-orchestrator.md
      ```
      ...
      **3. Try a Complete Workflow**:
      ...
      Follow your testing guide (example: `.talon/TESTING.md`) for complete testing:
      ...
      - **System Overview**: `.talon/README.md`
      - **Architecture Guide**: (example: `.talon/ARCHITECTURE.md`)
      - **Quick Start**: (example: `.talon/QUICK-START.md`)
      - **Testing Guide**: (example: `.talon/TESTING.md`)
      - **Context Organization**: `.talon/context/`
      - **Workflow Guide**: (example: `.talon/workflows/navigation.md`)
