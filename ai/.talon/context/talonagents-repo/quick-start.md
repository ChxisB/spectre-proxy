<!-- Context: talonagents-repo/quick-start | Priority: critical | Version: 1.0 | Updated: 2026-02-15 -->

# TalonAgents Control Repository - Quick Start
...
TalonAgents Control is an AI agent framework with:
...
```
.talon/agent/core/                    # Core agents (talonagent, taloncoder)
.talon/agent/{category}/              # Category agents
.talon/agent/subagents/               # Subagents
...
.talon/context/                       # Context files
.talon/command/                       # Slash commands
docs/                                    # Documentation
