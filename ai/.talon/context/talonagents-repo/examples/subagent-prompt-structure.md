...
**Files**:
- Optimized: `.talon/agent/subagents/core/contextscout.md`
- Backup: (example: `.talon/agent/ContextScout-original-backup.md`)
...
**Reference**: `.talon/command/prompt-engineering/prompt-optimizer.md` (optimization principles)
