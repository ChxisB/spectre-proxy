...
Create a new data analyst agent for the TalonAgents Control repository. This agent will specialize in data analysis tasks including data visualization, statistical analysis, and data transformation.
...
- Agent file must be in `.talon/agent/data/` directory (category-based organization)
...
**File Structure**:
- Agent file: `.talon/agent/data/data-analyst.md`
...
**Create**:
- `.talon/agent/data/data-analyst.md` - Main agent definition with frontmatter and prompt
...
- `.talon/context/navigation.md` - Add data category context if needed
...
**Your Task**:
Create a complete data analyst agent for the TalonAgents Control repository following all established conventions and standards.
...
2. **Create Agent File**:
   - Create `.talon/agent/data/data-analyst.md`
