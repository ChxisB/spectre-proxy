...
**What Happens**:
- TalonAgent runs as primary agent
- TalonAgent uses `task` tool to delegate to ContextScout
...
**Common Mistake**:
```bash
# ❌ WRONG - This runs TalonAgent, not ContextScout
