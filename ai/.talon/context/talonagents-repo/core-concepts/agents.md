...
**Purpose**: Understanding how agents work in TalonAgents Control  
...
Agents:
- `talonagent.md` - General-purpose orchestrator
- `taloncoder.md` - Development specialist
...
**Location**: `.talon/agent/subagents/`
...
TalonAgents Control can pair with Claude Code for local workflows and distribution:
...
Use this when you want Claude Code to follow TalonAgents Control standards or to ship reusable helpers.
...
"talonagent" → resolves to → ".talon/agent/core/talonagent.md"

# Category path
"core/talonagent" → resolves to → ".talon/agent/core/talonagent.md"

# Full category path
"development/frontend-specialist" → resolves to → ".talon/agent/subagents/development/frontend-specialist.md"

# Subagent path
"TestEngineer" → resolves to → ".talon/agent/subagents/code/test-engineer.md"
```
...
**Location**: `.talon/prompts/{category}/{agent}/`
...
Loads: `.talon/context/core/standards/code-quality.md`
...
Loads: `.talon/context/ui/web/react-patterns.md`
...
```bash
# Create agent file
touch .talon/agent/{category}/{agent-name}.md
...
- **Core agents**: `{name}.md` (e.g., `talonagent.md`)
