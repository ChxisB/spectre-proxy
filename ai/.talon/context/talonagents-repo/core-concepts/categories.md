...
.talon/agent/subagents/development/
├── 0-category.json             # Subagent category metadata
├── frontend-specialist.md
└── devops-specialist.md

.talon/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
"talonagent" → ".talon/agent/core/talonagent.md"

# Subagent path
"subagents/development/frontend-specialist" → ".talon/agent/subagents/development/frontend-specialist.md"

# Subagent path
"TestEngineer" → ".talon/agent/subagents/code/test-engineer.md"
```
...
mkdir -p .talon/agent/{category}

# Create context directory
mkdir -p .talon/context/{category}
...
```bash
cat > .talon/agent/{category}/0-category.json << 'EOF'
{
  "name": "Category Name",
  "description": "Brief description",
  "icon": "🎯",
...
```bash
cat > .talon/context/{category}/navigation.md << 'EOF'
...
- `talonagent` → resolves to `core/talonagent`
- `taloncoder` → resolves to `core/taloncoder`
