<!-- Context: talonagents-repo/registry | Priority: high | Version: 1.0 | Updated: 2026-02-15 -->
...
The registry is a centralized catalog (`registry.json`) that tracks all components in TalonAgents Control:
...
```json
{
  ...
  "type": "agent",
  "path": ".talon/agent/subagents/development/frontend-specialist.md",
...
The auto-detect system scans `.talon/` and automatically updates the registry.

### How It Works

```
1. Scan .talon/ directory
...
✅ **Agents** - `.talon/agent/{category}/*.md`  
✅ **Subagents** - `.talon/agent/subagents/**/*.md`  
✅ **Commands** - `.talon/command/**/*.md`  
✅ **Tools** - `.talon/tool/**/index.ts`  
✅ **Contexts** - `.talon/context/**/*.md`  
...
```bash
# Example errors
ERROR: Path does not exist: (example: .talon/agent/core/missing.md)
...
- talonagent: Universal coordination agent
- taloncoder: Complex coding and architecture
...
**Includes**:
- Core agents (talonagent, taloncoder)
...
```bash
File exists: .talon/agent/core/talonagent.md
