<!-- Context: talonagents-repo/context-bundle-template | Priority: low | Version: 1.0 | Updated: 2026-02-15 -->

---
description: "Template for creating context bundles when delegating tasks to subagents"
type: "context"
category: "talonagents-repo"
...
**Core Standards**:
- `.talon/context/core/standards/code-quality.md` → Modular, functional code patterns
- `.talon/context/core/standards/test-coverage.md` → Testing requirements and TDD
- `.talon/context/core/standards/documentation.md` → Documentation standards
- `.talon/context/core/standards/security-patterns.md` → Error handling, security patterns

**Core Workflows**:
- `.talon/context/core/workflows/task-delegation-basics.md` → Delegation process
- `.talon/context/core/workflows/feature-breakdown.md` → Task breakdown methodology
- `.talon/context/core/workflows/code-review.md` → Code review guidelines

## Repository-Specific Context (Load These Before Starting)

**Quick Start** (ALWAYS load first):
- `.talon/context/talonagents-repo/quick-start.md` → Repo orientation and common commands

**Core Concepts** (Load based on task type):
- `.talon/context/talonagents-repo/core-concepts/agents.md` → How agents work
- `.talon/context/talonagents-repo/core-concepts/evals.md` → How testing works
- `.talon/context/talonagents-repo/core-concepts/registry.md` → How registry works
- `.talon/context/talonagents-repo/core-concepts/categories.md` → How organization works

**Guides** (Load for specific workflows):
- `.talon/context/talonagents-repo/guides/adding-agent-basics.md` → Step-by-step agent creation
- `.talon/context/talonagents-repo/guides/testing-agent.md` → Testing workflow
- `.talon/context/talonagents-repo/guides/updating-registry.md` → Registry workflow
- `.talon/context/talonagents-repo/guides/debugging.md` → Troubleshooting

**Lookup** (Quick reference):
- `.talon/context/talonagents-repo/lookup/file-locations.md` → Where everything is
- `.talon/context/talonagents-repo/lookup/commands.md` → Command reference
...
2. **Copy template**:
   ```bash
   cp .talon/context/talonagents-repo/templates/context-bundle-template.md \
...
See `.talon/context/talonagents-repo/examples/context-bundle-example.md` for a complete example.
