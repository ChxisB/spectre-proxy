...
**Core Standards**:
- `.talon/context/core/standards/code.md` → Modular, functional code patterns
- `.talon/context/core/standards/tests.md` → Testing requirements and TDD
- `.talon/context/core/standards/docs.md` → Documentation standards
- (example: `.talon/context/core/standards/patterns.md`) → Error handling, security patterns

**Core Workflows**:
- (example: `.talon/context/core/workflows/delegation.md`) → Delegation process
- (example: `.talon/context/core/workflows/task-breakdown.md`) → Task breakdown methodology
- (example: `.talon/context/core/workflows/review.md`) → Code review guidelines
