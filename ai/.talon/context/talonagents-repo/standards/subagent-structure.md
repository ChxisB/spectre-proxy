<!-- Context: talonagents-repo/standards/subagent-structure | Priority: critical | Version: 1.0 | Updated: 2026-01-31 -->
...
### 1. Frontmatter
- ONLY valid Talon fields (see agent-frontmatter.md)
...
- [ ] Valid Talon frontmatter (no extra fields)?
...
- `.talon/agent/subagents/code/tester.md` - Write-enabled with tests
- `.talon/agent/subagents/code/reviewer.md` - Read-only reviewer
- `.talon/agent/subagents/core/task-manager.md` - Restricted bash
