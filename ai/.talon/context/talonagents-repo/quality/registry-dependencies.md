...
|------|--------|---------|-------------|
| **agent** | `agent:id` | `agent:taloncoder` | Core agent profile |
...
- Code tasks → .talon/context/core/standards/code-quality.md (MANDATORY)
```
...
**Path normalization**:
```
File path:     .talon/context/core/standards/code-quality.md
Dependency:    context:core/standards/code
               ^^^^^^^ ^^^^^^^^^^^^^^^^^^^
               type    path (no .talon/, no .md)
```

**Examples**:
```
dependencies:
  - context:core/standards/code           # .talon/context/core/standards/code-quality.md
  - context:core/standards/docs           # .talon/context/core/standards/documentation.md
  - context:core/workflows/delegation     # .talon/context/core/workflows/task-delegation-basics.md
  - context:talonagents-repo/guides/adding-agent  # Project-specific context
```
...
- context:core/standards/code (referenced 3 times)
  - Line 64: "Code tasks → .talon/context/core/standards/code-quality.md"
...
✗ Dependency not found: taloncoder → context:core/standards/code

Missing dependencies: 1
  - taloncoder (agent) → context:core/standards/code
...
```bash
git add .talon/agent/my-agent.md registry.json
...
```bash
# Make your changes
vim .talon/context/core/standards/code-quality.md
```
...
```bash
git commit -m "Update code standards - affects taloncoder, talonagent, reviewer"
```
...
**3. Delete component**:
```bash
rm .talon/agent/subagents/old-agent.md
```
...
/check-context-deps reports:
  taloncoder: missing context:core/standards/code
```
...
# Option 2: Manual fix
# Edit .talon/agent/core/taloncoder.md
# Add to frontmatter:
dependencies:
  - context:core/standards/code
...
ls -la .talon/context/core/standards/code-quality.md
...
rm .talon/context/core/standards/code-analysis.md
./scripts/registry/auto-detect-components.sh --auto-add
```
...
- **Registry Guide**: `.talon/context/talonagents-repo/guides/updating-registry.md`
- **Registry Concepts**: `.talon/context/talonagents-repo/core-concepts/registry.md`
