...
**Context**: talonagents-repo/guides | **Priority**: HIGH | **Updated**: 2026-01-09
...
Subagents are **delegated to** by parent agents (TalonAgent, TalonCoder, etc.). The parent agent already requested and received approval before delegating. Therefore:
...
- ✅ Primary agents (TalonAgent, TalonCoder, System Builder)
...
- **Testing subagents**: `.talon/context/talonagents-repo/guides/testing-subagents.md`
- **Subagent invocation**: `.talon/context/talonagents-repo/guides/subagent-invocation.md`
- **Agent concepts**: `.talon/context/talonagents-repo/core-concepts/agents.md`
