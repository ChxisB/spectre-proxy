...
**Purpose**: Quick reference for publishing TalonAgents Control to npm
...
TalonAgents Control is published as `@nextsystems/oac` on npm. Users install globally and run `oac [profile]` to set up their projects.
...
- `.talon/` - Agents, commands, context, profiles, skills, tools
