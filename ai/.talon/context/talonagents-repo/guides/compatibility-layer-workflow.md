...
2. **Type System** (1.5h) ✅
   ...
   - Define `TalonAgentSchema`, `AgentFrontmatterSchema`
...
2. **Create Adapter Class**
   ...
   export class NewToolAdapter extends BaseAdapter {
     ...
     validateConversion(agent: TalonAgent): string[] { /* ... */ }
   }
   ```
...
- **Issue**: https://github.com/darrenhinde/TalonAgentsControl/issues/141
