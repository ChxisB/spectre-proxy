...
```bash
# List issues
gh issue list --repo darrenhinde/TalonAgentsControl

# Create issue
gh issue create --repo darrenhinde/TalonAgentsControl --title "Title" --body "Body" --label "label1,label2"

# Add issue to project
gh project item-add 2 --owner darrenhinde --url https://github.com/darrenhinde/TalonAgentsControl/issues/NUMBER

# View issue
gh issue view NUMBER --repo darrenhinde/TalonAgentsControl

# Update issue
gh issue edit NUMBER --repo darrenhinde/TalonAgentsControl --add-label "new-label"

# Close issue
gh issue close NUMBER --repo darrenhinde/TalonAgentsControl
```
...
# Basic issue
gh issue create \
  --repo darrenhinde/TalonAgentsControl \
...
gh project item-add 2 \
  --owner darrenhinde \
  --url https://github.com/darrenhinde/TalonAgentsControl/issues/NUMBER
```
...
for i in {137..142}; do
  gh project item-add 2 \
    --owner darrenhinde \
    --url https://github.com/darrenhinde/TalonAgentsControl/issues/$i
done
```
...
1. **Assign issue to yourself**
   ```bash
   gh issue edit NUMBER --repo darrenhinde/TalonAgentsControl --add-assignee @me
   ```
