...
# Building CLIs in TalonAgents Control: Compact Guide

**Category**: guide  
**Purpose**: Rapidly build, register, and deploy CLI tools for TalonAgents Control skills  
...
**Reference**: See `.talon/context/talonagents-repo/guides/adding-skill-basics.md` for the full, detailed walkthrough.
