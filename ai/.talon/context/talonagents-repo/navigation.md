<!-- Context: talonagents-repo/navigation | Priority: critical | Version: 1.0 | Updated: 2026-02-15 -->

# TalonAgents Control Repository Context

**Purpose**: Context files specific to the TalonAgents Control repository
...
| File | Topic | Priority |
|------|-------|----------|
| `standards/agent-frontmatter.md` | Valid Talon YAML frontmatter | ⭐⭐⭐⭐⭐ |
...
| `guides/adding-skill-basics.md` | How to add Talon skills | ⭐⭐⭐⭐ |
