<!-- Context: talonagents-repo/context-overview | Priority: low | Version: 1.0 | Updated: 2026-02-15 -->

# Talon Plugin Context Library

This library provides structured context for AI coding assistants to understand, build, and extend Talon plugins. Depending on your task, you can load specific parts of this library.
