<!-- Context: talonagents-repo/lifecycle | Priority: low | Version: 1.0 | Updated: 2026-02-15 -->
...
Plugins have full access to the Talon SDK via `context.client`. This allows:
