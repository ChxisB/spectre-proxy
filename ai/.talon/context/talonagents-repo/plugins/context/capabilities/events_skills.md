<!-- Context: talonagents-repo/events_skills | Priority: low | Version: 1.0 | Updated: 2026-02-15 -->

# Talon Events: Skills Plugin Implementation

## Overview

This document explains how the Talon Skills Plugin uses event hooks (`tool.execute.before` and `tool.execute.after`) to implement skill delivery and output enhancement. This is a practical example of the event system described in `events.md`.
...
## Integration with Talon Event System

### Event Mapping

| Talon Event | Skills Plugin Hook | Purpose |
|---|---|---|
...
↓
Talon: Calls skills_brand_guidelines tool
```
...
- **Talon Events**: `context/capabilities/events.md`
