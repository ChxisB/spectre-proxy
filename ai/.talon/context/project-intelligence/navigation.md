...
```
.talon/context/project-intelligence/
...
- `.talon/context/core/standards/project-intelligence.md` (standards and patterns)
- `.talon/context/core/system/context-guide.md` (context loading)

See `.talon/context/core/context-system.md` for the broader context architecture.
...
**Management Guide**: See `.talon/context/core/standards/project-intelligence-management.md` for complete lifecycle management including:
...
See `.talon/context/core/standards/project-intelligence.md` for the standard itself.
