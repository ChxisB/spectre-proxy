...
- .talon/context/core/standards/code-quality.md - CRITICAL
- .talon/context/core/standards/test-coverage.md - CRITICAL
```
...
# Load the standards
cat .talon/context/core/standards/code-quality.md
```
