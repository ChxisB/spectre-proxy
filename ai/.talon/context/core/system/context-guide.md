...
**Index Location**: `.talon/context/navigation.md` - Quick map of all contexts
...
**Central Index**: `.talon/context/navigation.md` - Ultra-compact map of all contexts
...
All files are in `.talon/context/core/` with organized subfolders:
...
- Load `.talon/context/navigation.md`
...
### .talon/context/core/standards/code-analysis.md
...
### .talon/context/core/workflows/feature-breakdown.md
- Tasks with 4+ files
- Estimated effort >60 minutes
- Complex dependencies

### .talon/context/core/workflows/session-management.md
- Session lifecycle
- Cleanup procedures
- Session isolation
