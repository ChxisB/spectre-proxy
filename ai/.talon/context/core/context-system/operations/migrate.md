...
**Purpose**: Copy context files from global (`~/.config/talon/context/`) to local (`.talon/context/`) so they're project-specific and git-committed.
...
Users who installed OAC globally have project-intelligence files at `~/.config/talon/context/project-intelligence/`. These files are project-specific patterns but aren't committed to git or shared with the team.
...
Global location: ~/.config/talon/context/
...
```
No global context found at ~/.config/talon/context/
...
```
Global context found at ~/.config/talon/context/ but no project-intelligence/ directory.
...
If local `.talon/context/project-intelligence/` already exists:
...
Will copy from: ~/.config/talon/context/project-intelligence/
Will copy to:   .talon/context/project-intelligence/
...
**Actions on approval:**
1. Create `.talon/context/project-intelligence/` if it doesn't exist
...
Copied 3 files to .talon/context/project-intelligence/
...
- Delete `~/.config/talon/context/project-intelligence/` only
- Do NOT touch `~/.config/talon/context/core/` or any other global context
...
**Permission denied:**
```
Error: Cannot write to .talon/context/project-intelligence/
Check directory permissions and try again.
```

**Global path not found:**
```
No global Talon config found at ~/.config/talon/

If you installed to a custom location, set TALON_INSTALL_DIR:
  export TALON_INSTALL_DIR=/your/custom/path
  /context migrate
```
...
- Context path resolution: `.talon/context/core/system/context-paths.md`
