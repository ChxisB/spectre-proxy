...
<rule id="size_limits" enforcement="strict">
  ...
  - Reference index (RTK): max 100 lines
</rule>

**Why**: Forces brevity. If you need more, convert to RTK format — extract core patterns inline and move detailed content to dedicated files loaded via `@ref:` codes. See `guides/rtk.md`.
