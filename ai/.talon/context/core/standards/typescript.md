...
- **Talon TypeScript**: `.talon/context/talonagents-repo/standards/talon-typescript.md` (framework-specific patterns)
- **Code Quality**: `.talon/context/core/standards/code-quality.md` (general quality standards)
- **Test Coverage**: `.talon/context/core/standards/test-coverage.md` (testing standards)
