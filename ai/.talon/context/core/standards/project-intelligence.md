...
> **Where**: `.talon/context/project-intelligence/` (dedicated folder)
...
**Full Management Guide**: See `.talon/context/core/standards/project-intelligence-management.md`
...
- **Reference**: See `.talon/context/core/context-system.md` for system overview

## Related Files

- **Management Guide**: `.talon/context/core/standards/project-intelligence-management.md`
- **Context System**: `.talon/context/core/context-system.md`
- **Standards Index**: `.talon/context/core/standards/navigation.md`
