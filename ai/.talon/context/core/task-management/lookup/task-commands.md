...
```bash
npx ts-node .talon/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `.talon/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
