...
task(
  ...
  prompt="Context to load:
          - .talon/context/core/visual-development.md
...
- **UI Design Workflow**: `.talon/context/core/workflows/design-iteration-overview.md`
- **Design Systems**: `.talon/context/ui/web/design-systems.md`
- **UI Styling Standards**: `.talon/context/ui/web/ui-styling-standards.md`
- **Animation Patterns**: `.talon/context/ui/web/animation-basics.md`, `.talon/context/ui/web/animation-advanced.md`
- **Subagent Invocation Guide**: `.talon/context/talonagents-repo/guides/subagent-invocation.md`
- **Agent Capabilities**: `.talon/context/talonagents-repo/core-concepts/agents.md`
