...
{
  contextFiles: [
    "(example: .talon/context/architecture/patterns.md)"
  ],
  referenceFiles: [
    "src/auth/old-auth.ts"
  ],
...
{
  contextFiles: [
    "(example: .talon/context/core/prioritization/scoring.md)"
  ],
  referenceFiles: [],
  agentOutputs: [
    ".tmp/story-maps/auth-system/map.json"
...
createContextIndex('auth-system', {
  contextFiles: glob('.talon/context/**/*.md') // Too much!
});
```
...
#   "feature": "auth-system",
#   "agentType": "StoryMapper",
#   "contextFiles": ["(example: .talon/context/core/story-mapping/guide.md)"],
