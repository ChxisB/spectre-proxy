...
```typescript
import { createSession } from ".talon/skill/task-management/scripts/session-context-manager";
...
```typescript
import { loadSession } from ".talon/skill/task-management/scripts/session-context-manager";
...
updateSession(sessionId, {
  contextFiles: [
    ".talon/context/core/standards/code-quality.md",
    ".talon/context/core/standards/security-patterns.md",
    "(example: .talon/context/core/standards/naming-conventions.md)",
  ],
  referenceFiles: [
...
updateSession(sessionId, {
  contextFiles: [".talon/context/core/standards/code-quality.md"],
...
- `.talon/skill/task-management/scripts/session-context-manager.ts` - Implementation
- `.talon/context/core/task-management/standards/task-schema.md` - Task JSON schema
- `.talon/context/core/workflows/task-delegation-basics.md` - Multi-agent orchestration
