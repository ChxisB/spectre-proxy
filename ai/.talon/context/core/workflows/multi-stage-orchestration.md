...
**Key Agents**: TalonCoder (orchestrator), TaskManager, BatchExecutor, CoderAgent, ContextScout, ExternalScout
...
**Primary Agent**: TalonCoder (orchestrator)
...
**CLI**: `.talon/skill/task-management/scripts/task-cli.ts`
...
**Standards Location**: `.talon/context/core/standards/`

**Workflows Location**: `.talon/context/core/workflows/`

**Usage**: Referenced in task `context_files` arrays

### Agent Configuration Integration

**Location**: `.talon/agent/subagents/core/`
...
┌──────────────────────────────────────────────────────────────────────┐
│ Stage 7: Integration & Validation                                    │
│ Agent: TalonCoder + CoderAgent + TestEngineer                        │
