...
- Answer is in `.talon/context/` (use ContextScout instead)
...
- **ExternalScout**: `.talon/agent/subagents/core/externalscout.md`
- **External Context Management**: `.talon/context/core/workflows/external-context-management.md`
- **Task Delegation**: `.talon/context/core/workflows/task-delegation-basics.md`
