...
```typescript
import { createContextIndex } from './.talon/skill/task-management/scripts/context-index';
...
const result = createContextIndex('auth-system', {
  contextFiles: [
    ...
    '(example: (example: .talon/context/security/auth-patterns.md))',
    '(example: (example: .talon/context/architecture/ddd-patterns.md))',
    '(example: (example: .talon/context/core/story-mapping/guide.md))'
  ],
  referenceFiles: [
...
```typescript
import { getContextForAgent } from './.talon/skill/task-management/scripts/context-index';
...
// Returns:
{
  ...
  contextFiles: [
    "(example: .talon/context/architecture/ddd-patterns.md)"
  ],
  referenceFiles: [
    "src/auth/old-auth.ts",
    "src/middleware/auth.middleware.ts"
...
```typescript
import { addAgentOutput } from './.talon/skill/task-management/scripts/context-index';
...
// Returns:
{
  ...
  contextFiles: [
    "(example: .talon/context/core/story-mapping/guide.md)"
  ],
  referenceFiles: [],
  agentOutputs: [
    ".tmp/architecture/auth-system/contexts.json"
...
// Returns:
{
  ...
  contextFiles: [
    ".talon/context/core/standards/code-quality.md",
    "(example: .talon/context/security/auth-patterns.md)"
  ],
  referenceFiles: [],
  agentOutputs: [
    ".tmp/tasks/auth-system/task.json"
...
import { 
  ...
  addAgentOutput, 
  getContextForAgent 
} from './.talon/skill/task-management/scripts/context-index';
