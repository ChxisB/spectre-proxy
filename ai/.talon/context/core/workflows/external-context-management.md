...
### For Main Agents (TalonAgent, etc.)
...
- **ExternalScout**: `.talon/agent/subagents/core/externalscout.md` — Fetches and persists external docs
- **Task Delegation**: `.talon/context/core/workflows/task-delegation-basics.md` — How to reference external context in sessions
- **Session Management**: `.talon/context/core/workflows/session-management.md` — Session lifecycle
- **Library Registry**: `.talon/skills/context7/library-registry.md` — Supported libraries and query patterns
