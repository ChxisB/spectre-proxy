...
**Rule**: If it's not in `.talon/context/`, use ExternalScout.
...
| **Location** | `.talon/context/` | Internet (Context7, docs) |
...
**See**: `.talon/skills/context7/library-registry.md`
...
- `.talon/agent/subagents/core/externalscout.md` - ExternalScout agent
