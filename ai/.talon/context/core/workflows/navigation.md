...
|------|-------|----------|-----------|
| `agent-pipeline.md` | **Agent workflow — who does what** | ⭐⭐⭐⭐⭐ | **ANY complex task — START HERE** |
...
1. Load `agent-pipeline.md` (critical) — see which agents handle each stage
2. Then load the specific workflow for the stage you're in
...
- **TalonAgents Control Delegation** → `../../talonagents-repo/guides/subagent-invocation.md`
