...
**New here?** → `talonagents-repo/quick-start.md`
...
├── talonagents-repo/        # TalonAgents Control repository work
...
| **Add agent** | `talonagents-repo/guides/adding-agent.md` |
...
**talonagents-repo/** - Repository-specific → `talonagents-repo/navigation.md`
