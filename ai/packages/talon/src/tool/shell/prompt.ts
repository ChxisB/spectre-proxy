...
Usage notes:
  ...
  - Command output is automatically filtered to reduce noise — trailing whitespace is removed, blank lines are normalized, and repeated lines are collapsed. This is transparent and saves tokens without losing information.
