...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Talon from reading sensitive files",
  ...
  "Run {highlight}talon serve{/highlight} for headless API access to Talon",
  ...
  "Use {highlight}/connect{/highlight} with Talon Zen for curated, tested models",
